...
internal class InitialData
{
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", Domain.Enums.PaymentMethod.Credit);
            var payment2 = Payment.Of("john", "8885555555554444", "06/30", "222", Domain.Enums.PaymentMethod.Debit);
